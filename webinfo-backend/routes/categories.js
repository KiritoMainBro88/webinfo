...
router.post('/', authAdmin, upload.single('categoryIconImage'), async (req, res) => {
    ...
    try {
        ...
        if (req.file) {
             console.log('Category Icon Uploaded:', req.file.path); // req.file.path contains the Cloudinary URL
...
router.put('/:id', authAdmin, upload.single('categoryIconImage'), async (req, res) => {
    ...
    if (req.file) {
        ...
        updateData.iconImageUrl = req.file.path; // Overwrite existing or add new
    }
